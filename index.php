...
<section class="featuredCompanies">
    <div style="filter: drop-shadow(50px 50px 50px rgba(0,0,0,15%));background-color: white;padding: 15px 30px;">
        <?php 
...
<div class="breathLine"><span></span></div>
...
<section class="blogPosts">
    ...
    <div style="display: flex;justify-content: space-between;align-items: baseline;">
        ...
        <a href="#" class="allPostsCta">
            <svg width="22" height="8" viewBox="0 0 22 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M21.3536 4.35355C21.5488 4.15829 21.5488 3.84171 21.3536 3.64644L18.1716 0.464465C17.9763 0.269202 17.6597 0.269202 17.4645 0.464465C17.2692 0.659727 17.2692 0.976309 17.4645 1.17157L20.2929 4L17.4645 6.82843C17.2692 7.02369 17.2692 7.34027 17.4645 7.53553C17.6597 7.73079 17.9763 7.73079 18.1716 7.53553L21.3536 4.35355ZM4.37114e-08 4.5L21 4.5L21 3.5L-4.37114e-08 3.5L4.37114e-08 4.5Z" fill="white"/>
            </svg> Ver mais no nosso blog
        </a>
    </div>
    ...
    <div class="background" style="background-image: url('<?php echo get_template_directory_uri() . '/assets/images/blogPostsBg.jpg' ?>');"></div>
</section>
